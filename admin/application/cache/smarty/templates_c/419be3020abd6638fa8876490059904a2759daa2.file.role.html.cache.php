<?php /* Smarty version Smarty-3.1.18, created on 2014-11-23 16:17:20
         compiled from "D:\wamp\Apache2.2\www\tpgy\admin\static\views\user\role.html" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5471981066c379_27355675',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5471981066c379_27355675')) {function content_5471981066c379_27355675($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ('../header.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array(), 0);?>
...
<div class="so_main">
 ...
 <!--  <div id="searchUser_div" <neq name="type" value="searchUser">style="display:none;"</neq>>
  ...
  <div class="Toolbar_inbox">
	...
	<a href="<?php echo $_smarty_tpl->tpl_vars['addRole']->value;?>
" class="btn_a"><span>添加角色</span></a>
...
?>
	  <tr overstyle='on' id="user_<?php echo $_smarty_tpl->tpl_vars['vo']->value['rid'];?>
">
	  
	    <td><input type="checkbox" name="checkbox" id="checkbox2" onclick="checkon(this)" value="<?php echo $_smarty_tpl->tpl_vars['vo']->value['rid'];?>
"></td>
	    <td><?php echo $_smarty_tpl->tpl_vars['vo']->value['rid'];?>
</td>
	    <td>
			...
			<div style="float:left"><space uid="<?php echo $_smarty_tpl->tpl_vars['vo']->value['rid'];?>
" class="fn" target="_blank"><?php echo $_smarty_tpl->tpl_vars['vo']->value['title'];?>
	    ...
	    <td>
			<a href="<?php echo $_smarty_tpl->tpl_vars['addRole']->value;?>
<?php echo $_smarty_tpl->tpl_vars['vo']->value['rid'];?>
">编辑</a>
		
	    <!-- 	<a href="javascript:void(0);" onclick="deleteUser(<?php echo $_smarty_tpl->tpl_vars['vo']->value['rid'];?>
);">删除</a> -->
			
	    	<a href="javascript:void(0);" onclick="doAuth(<?php echo $_smarty_tpl->tpl_vars['vo']->value['rid'];?>
)">审核</a>

	    	<a href="javascript:void(0);" onclick="doAuthRole(<?php echo $_smarty_tpl->tpl_vars['vo']->value['rid'];?>
)">分配权限</a>
		</td>
	  </tr>
  <!-- </volist> -->
...
<script>
	...
	function deleteUser(uid) {
		var ulr = "<?php if (isset($_smarty_tpl->tpl_vars['delRole']->value)) {?><?php echo $_smarty_tpl->tpl_vars['delRole']->value;?>
<?php }?>";
		var length = 0;
		if(uid) {
		    length = 1;         
...
"+status+"<?php }?>";
	...
	function doAuthRole(status){
		var url = "<?php if (isset($_smarty_tpl->tpl_vars['authRoleUrl']->value)) {?><?php echo $_smarty_tpl->tpl_vars['authRoleUrl']->value;?>
"+status+"<?php }?>";
